...
def create_app() -> FastAPI:
    ...
    router.include_router(leaderboards_router, tags=["Tournaments"])
    router.include_router(pools_router, tags=["Tournaments"])
    router.include_router(matches_router, tags=["Tournaments"])
